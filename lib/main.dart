...
class FatoraApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Brightness brilhoSistema = MediaQuery.platformBrightnessOf(context);
    final bool modoEscuroAtivo = brilhoSistema == Brightness.dark;

    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: SystemUiOverlayStyle(
        statusBarColor: Colors.transparent,
        statusBarIconBrightness: modoEscuroAtivo
            ? Brightness.light
            : Brightness.dark,
        statusBarBrightness: modoEscuroAtivo
            ? Brightness.dark
            : Brightness.light,
        systemNavigationBarColor: Colors.transparent,
        systemNavigationBarIconBrightness: modoEscuroAtivo
            ? Brightness.light
            : Brightness.dark,
